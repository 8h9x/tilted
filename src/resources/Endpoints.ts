const Endpoints: Record<string, string> = Object.freeze({
  // AUTH
  ...
  // INITIAL SETUP
  INIT_EULA:
    "https://eulatracking-public-service-prod-m.ol.epicgames.com/eulatracking/api/public/agreements/fn",
  INIT_GRANTACCESS:
    "https://fngw-mcp-gc-livefn.ol.epicgames.com/fortnite/api/game/v2/grant_access",
  ...
  // PUBLIC KEY
  PUBLICKEY:
    "https://publickey-service-prod.ecbc.live.use1a.on.epicgames.com/publickey",
  ...
  // BATTLE ROYALE
  BR_STATS_V2:
    "https://statsproxy-public-service-live.ol.epicgames.com/statsproxy/api/statsv2",
  BR_SERVER_STATUS:
  ...
  BR_STORE_KEYCHAIN:
    "https://fngw-mcp-gc-livefn.ol.epicgames.com/fortnite/api/storefront/v2/keychain?numKeysDownloaded=0",
  BR_NEWS:
  ...
  BR_SAC_SEARCH:
    "https://payment-website-pci.ol.epicgames.com/affiliate/search-by-slug",
  BR_SAC:
    "https://affiliate-public-service-prod.ol.epicgames.com/affiliate/api/public/affiliates/slug",
  BR_PARTY: "https://party-service-prod.ol.epicgames.com/party/api/v1/Fortnite",
  BR_TOURNAMENTS:
    "https://events-public-service-live.ol.epicgames.com/api/v1/events/Fortnite/data",
  BR_TOURNAMENTS_DOWNLOAD:
    "https://events-public-service-live.ol.epicgames.com/api/v1/events/Fortnite/download",
  BR_TOURNAMENT_WINDOW:
    "https://events-public-service-live.ol.epicgames.com/api/v1/leaderboards/Fortnite",
  BR_TOURNAMENT_TOKENS:
    "https://events-public-service-live.ol.epicgames.com/api/v1/players/Fortnite/tokens",
  BR_STREAM: "https://fortnite-vod.akamaized.net",
  BR_REPLAY:
    "https://datastorage-public-service-live.ol.epicgames.com/api/v1/access/fnreplays/public",
  BR_REPLAY_METADATA:
    "https://datastorage-public-service-live.ol.epicgames.com/api/v1/access/fnreplaysmetadata/public",
  BR_GIFT_ELIGIBILITY:
    "https://fngw-mcp-gc-livefn.ol.epicgames.com/fortnite/api/storefront/v2/gift/check_eligibility",

  // CREATIVE
  CREATIVE_ISLAND_LOOKUP:
    "https://links-public-service-live.ol.epicgames.com/links/api/fn/mnemonic",
  CREATIVE_DISCOVERY:
    "https://fn-service-discovery-live-public.ogs.live.on.epicgames.com/api/v1/discovery/surface",
  ...
  ACCOUNT_ID:
    "https://account-public-service-prod.ol.epicgames.com/account/api/public/account",
  ACCOUNT_EMAIL:
    "https://account-public-service-prod.ol.epicgames.com/account/api/public/account/email",
  ACCOUNT_SEARCH:
    "https://user-search-service-prod.ol.epicgames.com/api/v1/search",
  ACCOUNT_AVATAR:
    "https://avatar-service-prod.identity.live.on.epicgames.com/v1/avatar",
  ACCOUNT_GLOBAL_PROFILE:
  ...
  FRIEND_ADD:
    "https://friends-public-service-prod.ol.epicgames.com/friends/api/public/friends",
  FRIEND_DELETE:
    "https://friends-public-service-prod.ol.epicgames.com/friends/api/v1",
  FRIEND_BLOCK:
    "https://friends-public-service-prod.ol.epicgames.com/friends/api/public/blocklist",

  // SERVER STATUS
  SERVER_STATUS_SUMMARY:
    "https://ft308v428dv3.statuspage.io/api/v2/summary.json",
